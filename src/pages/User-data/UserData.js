...
const UserData = () => {
    const [users, setUsers] = useState([
        { id: 1, name: 'Sonali', email: 'sonali@example.com', status: 'Active', role: 'Admin' },
        { id: 2, name: 'Sonia', email: 'sonia@example.com', status: 'Inactive', role: 'User' },
        { id: 3, name: 'Sri', email: 'sri@example.com', status: 'Active', role: 'User' },
        { id: 4, name: 'Ayushi', email: 'ayushi@example.com', status: 'Active', role: 'Editor' },
        { id: 5, name: 'Harsh', email: 'harsh@example.com', status: 'Inactive', role: 'User' },
    ]);
