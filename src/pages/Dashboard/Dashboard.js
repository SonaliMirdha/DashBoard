    ...
    <div className="dashboard">
      ...
      <div className="stats-grid">
        <div className="stats-card">
          <div className="stats-icon"><UsersIcon /></div>
          <div className="stats-info">
            <h3>Total Users</h3>
            <p className="stats-number">{stats.totalUsers}</p>
            <p className={`stats-change ${stats.userChangeType}`}>
        ...
        <div className="stats-card">
          <div className="stats-icon"><CurrencyDollarIcon /></div>
          <div className="stats-info">
            <h3>Revenue</h3>
            <p className="stats-number">{stats.revenue}</p>
            <p className={`stats-change ${stats.revenueChangeType}`}>
        ...
        <div className="stats-card">
          <div className="stats-icon"><ChartBarIcon /></div>
          <div className="stats-info">
            <h3>Active Projects</h3>
            <p className="stats-number">{stats.activeProjects}</p>
            <p className={`stats-change ${stats.projectsChangeType}`}>
              {stats.projectsChange} from last month
            </p>
          </div>
        </div>

        <div className="stats-card">
          <div className="stats-icon"><CalendarIcon /></div>
          <div className="stats-info">
            <h3>Tasks Completed</h3>
            <p className="stats-number">{stats.tasksCompleted}</p>
            <p className={`stats-change ${stats.tasksChangeType}`}>
        ...
        <div className="stats-card">
          <div className="stats-icon"><TicketIcon /></div>
          <div className="stats-info">
            <h3>Support Tickets</h3>
            <p className="stats-number">{stats.supportTickets}</p>
            <p className={`stats-change ${stats.ticketsChangeType}`}>
              {stats.ticketsChange} from last week
            </p>
          </div>
        </div>

        <div className="stats-card">
          <div className="stats-icon"><CubeTransparentIcon /></div>
          <div className="stats-info">
            <h3>Pending Orders</h3>
            <p className="stats-number">{stats.pendingOrders}</p>
            <p className={`stats-change ${stats.ordersChangeType}`}>
              {stats.ordersChange} from yesterday
            </p>
          </div>
        </div>

        <div className="stats-card">
          <div className="stats-icon"><GlobeAltIcon /></div>
          <div className="stats-info">
            <h3>Website Traffic</h3>
            <p className="stats-number">{stats.websiteTraffic}</p>
            <p className={`stats-change ${stats.trafficChangeType}`}>
              {stats.trafficChange} from last month
            </p>
          </div>
        </div>
      </div>

      {/* Optionally include these later */}
      {/* 
